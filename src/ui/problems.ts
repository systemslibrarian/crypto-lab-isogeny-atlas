...
export const PROBLEMS: readonly Problem[] = [
  ...
  },
  {
    ...
    plain:
      'Type a message below and it walks the graph, one edge per bit — a real Charles–Goren–Lauter-style hash. But notice: to land anywhere, you walked there, so you know your own path back to the starting curve. Nobody knows how to produce a "random" supersingular curve without also learning a path to it — and many protocols need exactly such curves of no known origin.',
    precise:
